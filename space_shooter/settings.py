...
# UI Assets
ASSET_TITLE = os.path.join(RESOURCES_DIR, 'spacefighter.png')
ASSET_ROBOT = os.path.join(RESOURCES_DIR, 'Robot.jpeg')
ASSET_PEOPLE = os.path.join(RESOURCES_DIR, 'people.png')
ASSET_BORDER = os.path.join(RESOURCES_DIR, 'border.png')
ASSET_VIEN = os.path.join(RESOURCES_DIR, 'vien.png')
ASSET_PLAY_BTN = os.path.join(RESOURCES_DIR, 'PlayButton.png')
ASSET_HOME_BTN = os.path.join(RESOURCES_DIR, 'HomeButton.png')
